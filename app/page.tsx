    ...
    <main className="w-full max-w-sm flex flex-col gap-6 shrink-0">
      ...
      <div className="w-full bg-[#EDEFF3] rounded-2xl shadow-md p-6 flex flex-col items-center gap-4">
        ...
        <Link href="/register" className="w-full">
          <button className="w-full py-3 rounded-xl bg-[#8E9BB5] text-[#1F2A44] text-xl font-[var(--font-inter)]">
            Зарегистрироваться
          </button>
        </Link>

        <Link href="/login" className="w-full">
          <button className="px-6 py-2 rounded-xl bg-[#D6DAE3] text-[#1F2A44] text-xl font-[var(--font-inter)]">
            Войти
          </button>
        </Link>
      </div>
